        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center px-4 sm:px-6 animate-fade-in font-display">
            ...
            <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-surface-dark p-6 text-left shadow-2xl transition-all border border-gray-100 dark:border-gray-800 animate-scale-in">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-bold text-[#191011] dark:text-white">Edit Profil</h3>
                    <button
                        onClick={onClose}
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        <label className="block text-sm font-semibold text-[#191011] dark:text-gray-200">Foto Profil</label>
                        <div className="flex flex-col sm:flex-row items-center gap-5 p-5 rounded-2xl bg-background-light dark:bg-[#332a2a] border border-dashed border-primary/40 group">
                            ...
                            <div className="flex-1 w-full space-y-3">
                                ...
                                <div className="relative">
                                    <input className="w-full pl-9 pr-3 py-2 text-xs bg-white dark:bg-surface-dark border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-gray-400 text-[#191011] dark:text-white" placeholder="Atau tempel URL gambar..." type="text" />
                    ...
                    <div className="space-y-1.5">
                        <label className="block text-sm font-semibold text-[#191011] dark:text-gray-200">Nama</label>
                        <div className="relative">
                    ...
                    <div className="space-y-1.5">
                        <label className="block text-sm font-semibold text-[#191011] dark:text-gray-200">Bio / Status</label>
                        <div className="relative">
                        ...
                        <p className="text-xs text-[#8b5b5f] text-right">Maks. 50 karakter</p>
                    </div>
                </div>
